      ...
      <MapView 
        ...
        <View className="rounded-t-3xl -mt-12 bg-white relative">
            <View className="flex-row justify-between px-5 pt-10">
                ...
                <Image className="w-24 h-24" source={require('../assets/images/icons8-tropical-fish-96.png')}/>
            </View>
            <View 
                ...
                <View className="p-1 rounded-full"
                    style={{backgroundColor: 'rbga()255,255,255,0.4)'}}>
                        <Image className="h-16 w-16 rounded-full" 
                            source={require('../assets/images/icons8-tropical-fish-96.png')} />
